      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="about-reveal mb-20">
          ...
          <h2 className="text-black text-[clamp(2rem,4vw,3.5rem)] font-extralight tracking-tight leading-tight max-w-3xl">
            {t.aboutSubtitle} <span className="text-black/50">{t.technicalSkills}</span> {t.and} <span className="text-black/50">{t.businessVision}</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24">
          ...
          <div className="about-reveal">
            ...
            <div className="mt-8 p-6 rounded-2xl bg-black/[0.03]">
              <p className="text-xs text-black/40 tracking-[0.2em] uppercase font-light mb-3">{t.languages}</p>
